		...
		<div class="flex flex-wrap">
			...
			<div class="w-full self-end px-4 lg:w-1/2">
				<div class="relative mt-10 lg:mt-0 lg:right-0">
					<img src="img/tobi.png" alt="Tobi Albertino" class="max-w-full mx-auto" />
					<span class="absolute -bottom-0 -z-10 left-1/2 -translate-x-1/2 md:scale-125">
						<svg width="400" height="400" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
							<path
								fill="#14b8a6"
								d="M30.4,-26.3C42.2,-18.7,56.4,-9.3,55.4,-1C54.4,7.4,38.3,14.8,26.6,25.5C14.8,36.2,7.4,50.3,-3.6,53.9C-14.5,57.4,-29,50.5,-37.2,39.7C-45.4,29,-47.3,14.5,-45.2,2.1C-43.1,-10.3,-37,-20.7,-28.9,-28.3C-20.7,-36,-10.3,-41,-0.5,-40.5C9.3,-40,18.7,-34,30.4,-26.3Z"
